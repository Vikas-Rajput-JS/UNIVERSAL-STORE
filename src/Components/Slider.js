...
function Slider() {
  ...
  return (
    <div className='max-w-[1400px] h-[300px] sm:h-[400px] lg:h-[600px] w-full m-auto py-16 px-4 relative group'>
      <div
      ...
      <div className='hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-50%] left-5 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer'>
        <BsChevronCompactLeft onClick={prevSlide} className=' w-6 lg:w-20' />
      </div>
      {/* Right Arrow */}
      <div className='hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-50%] right-5 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer'>
        <BsChevronCompactRight onClick={nextSlide} className=' w-6 lg:w-20' />
      </div>
